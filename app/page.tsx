...
export default function HeroSectionOne() {
  return (
    <div className="relative min-h-screen bg-[#FAFAFA] text-slate-900 font-sans flex flex-col justify-between">
      <div>
        <Navbar />
        ...
        <div className="relative my-6 flex flex-col items-center justify-center">
          ...
          <div className="px-4 py-10 md:py-20 max-w-5xl mx-auto text-center">
            ...
            {/* Exact Original Container from Commit */}
            <motion.div
              initial={{
                opacity: 0,
                y: 10,
            ...
            {/* Interactive Voice Agent Simulator Section */}
